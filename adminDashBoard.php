              ...
              <div class="row">
                  <div class="card text-dark bg-light mb-3" style="max-width: 18rem; border-radius: 15px">
                    <div class="card-body">
                      ...
                      <h4>Courses</h4>
                          <a class="btn btn-primary btn-sm"href="addnewCourse.php">Add New</a>
                ...
                <div class="card text-dark bg-light mb-3" style="max-width: 18rem; border-radius: 15px">
                  <div class="card-body">
                    ...
                    <h4>Products</h4>
                          ...
                          <a class="btn btn-primary btn-sm"href="addnewProduct.php">Add New</a>
                ...
                <div class="card text-dark bg-light mb-3" style="max-width: 18rem; border-radius: 15px">
                  <div class="card-body">
                    ...
                    <h4>Books</h4>
                          ...
                          <a class="btn btn-primary btn-sm"href="addnewBook.php">Add New</a>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <?php 
                 ...
                 //query to get data from the table
                 $sqlorder = "Select * From Order_list";
                
                  $resultoder = mysqli_query($mysqli, $sqlorder);
                    if ($resultoder->num_rows > 0): 
                  
                ?>

                <?php while($array=mysqli_fetch_row($resultoder)): ?>
                <tr>
                    <td><?php echo $array[1];?></td>
                    <td><?php echo $array[2];?></td>
                    <td><?php echo $array[3];?></td>
                ...
                <?php endif; ?>
                <?php mysqli_free_result($resultoder); ?>
              </tbody>
            </table>
